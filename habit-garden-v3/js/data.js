...
HG.state = {
  completedToday: JSON.parse(localStorage.getItem('hg_done') || '["run"]'),
  dismissed:      JSON.parse(localStorage.getItem('hg_dismissed') || '[]'),
  liked:          JSON.parse(localStorage.getItem('hg_liked') || '[]'),
  save() {
    localStorage.setItem('hg_done',      JSON.stringify(this.completedToday));
    localStorage.setItem('hg_dismissed', JSON.stringify(this.dismissed));
    localStorage.setItem('hg_liked',     JSON.stringify(this.liked));
  }
};
